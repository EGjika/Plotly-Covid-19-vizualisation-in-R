---
title: "Dynamic Graphs in R Plotly"
author: "Eralda Gjika"
subtitle: Week 2 Data Science TEC Course
output:
...
```
# Basic graphs with plotly
[Reference](https://plotly.com/r/line-and-scatter/#basic-scatter-plot)
```{r}
library(plotly)
...
fig <- plot_ly(data = OWD, x = ~total_cases, y = ~continent)
...
fig <- plot_ly(data = OWD, x = ~new_cases, y = ~new_deaths,color = ~continent)
...
```
##Exercise
The code below is not working! Try to make it work and derive results!
